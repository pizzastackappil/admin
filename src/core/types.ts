...
export type AdminGetMeQuery = { __typename?: 'query_root', adminGetMe?: { __typename?: 'AdminGetMeQutput', id: string, username: string } | null };
...
export type CloudinarySignatureQuery = { __typename?: 'query_root', cloudinarySignature?: { __typename?: 'CloudinareSignatureOutput', apiKey: string, cloudName: string, publicId: string, signature: string, timestamp: number } | null };
